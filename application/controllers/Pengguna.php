...
class Pengguna extends CI_Controller
{
	...
	public function ajax_list_pengguna()
	{
		...
		foreach ($list as $pengguna) {
			...
			$row[] = $level;
			$row[] = "<a href='#' onClick='ubah_pengguna(" . $pengguna->log_id . ")' class='btn btn-info btn-sm' title='Ubah data pengguna'><i class='fa fa-edit'></i></a>&nbsp;<a href='#' onClick='hapus_pengguna(" . $pengguna->log_id . ")' class='btn btn-danger btn-sm' title='Hapus data pengguna'><i class='fa fa-trash-alt'></i></a>";
			$data[] = $row;
		}
