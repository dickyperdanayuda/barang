		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tabel-project" width="100%" style="font-size:120%;">
						<thead>
							<tr>
								<th>No</th>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form Project</h3>
			</div>
			<form role="form  col-lg-6" name="Barang" id="frm_project">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control tgl" name="tgl_project" id="tgl_project" placeholder="Tanggal Project" value="<?= date('d/m/Y'); ?>">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>Nama Project</label>
								<input type="text" class="form-control" name="nama_project" id="nama_project" placeholder="" required>
							</div>
						</div>
