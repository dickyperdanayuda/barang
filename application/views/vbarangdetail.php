<?php
$total = 0;
if (!empty($list_barangdetail)) {
	$data = explode("-", $list_barangdetail);
...
?>
							...
							<tr>
								<td colspan="7" align="center"><a href="#" onClick="inputBarangDetail()" class="btn btn-success"><i class="fa fa-plus"></i> &nbsp;&nbsp;&nbsp; Tambah Detail Purchase Barang</a></td>
							</tr>