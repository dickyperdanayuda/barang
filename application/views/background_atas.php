...
<head>
  ...
  <title><?= $this->session->userdata("username"); ?> | Management Barang</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span class="brand-text font-weight-light"><b>Management Barang</b></span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <?php if ($this->session->userdata('level') > 1) { ?>
              <img src="<?= base_url("assets/dist/img/foto.png" . $this->session->userdata('foto')); ?>" class="img-circle" alt="User Image">
            <?php } else { ?>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= base_url("Barang/tampil"); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= base_url("Request/tampil"); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= base_url("Pengajuan/tampil"); ?>" class="nav-link">
                <i class="nav-icon fas fa-file-export"></i>
                <p>
                  Pengajuan
                </p>
          ...
          <?php }else if ($this->session->userdata('level') == 2) { ?>
            ...
            <li class="nav-item">
              <a href="<?= base_url("Project/tampil"); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= base_url("Fix/tampil"); ?>" class="nav-link">
          ...
          <?php }else if ($this->session->userdata('level') == 3) { ?>
            ...
            <li class="nav-item">
              <a href="<?= base_url("BarangMasuk/tampil"); ?>" class="nav-link">
